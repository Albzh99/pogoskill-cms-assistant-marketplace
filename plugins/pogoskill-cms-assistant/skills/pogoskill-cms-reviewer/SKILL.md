...
- PoGoskill 模块必须先完整写完介绍、适用情境、操作思路、作用与优势，再放唯一正文下载 CTA；按钮下方必须紧接较大的现有 H3“PoGoskill 操作步驟”，随后才进入 `step-cont`。若按钮过早出现在介绍中间，或“PoGoskill 操作步驟”只有 `section-label` 小标签而没有 H3，判定为结构不合格。
